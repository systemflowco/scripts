document.addEventListener("DOMContentLoaded", function (event) {
    ...
    if (lastLesson) {
        ...
        continueBanner.querySelector(".continue-course-name-span").innerText = lastLesson.course;
        continueBanner.querySelector(".continue-lesson-name-span").innerText = lastLesson.lesson;
    } else {
